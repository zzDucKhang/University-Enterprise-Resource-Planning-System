...
-- Học kỳ
INSERT INTO semesters (id, semester_name, status) VALUES
(1, 'HK1 2024-2025', 'OPENING'),
(2, 'HK2 2024-2025', 'ONGOING'),
(3, 'HK1 2025-2026', 'OPENING');
...
-- Lớp học phần (học kỳ 3 = HK1 2025-2026, thứ Hai, tiết 1–4)
INSERT INTO class_sections (id, class_code, room, day_of_week, start_period, end_period, max_capacity, course_id, semester_id, lecturer_id) VALUES
(1, 'LHP001', 'P.301', 'MONDAY', 1, 4, 50, 1, 3, 1),
(2, 'LHP002', 'P.302', 'MONDAY', 1, 4, 50, 2, 3, 2);

-- Ghi danh mẫu (SV1 đã qua IT01 để có thể đăng ký IT02 nếu cần test tiên quyết)
INSERT INTO enrollments (id, score, status, student_id, class_section_id) VALUES
(1, 8.5, 'PASSED', 1, 1),
(2, NULL, 'REGISTERED', 1, 2);
...
<<<<<<< HEAD
ALTER TABLE enrollments AUTO_INCREMENT = 3;
